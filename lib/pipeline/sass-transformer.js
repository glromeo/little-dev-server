...
const {memoize, blockingTransformer} = require("../util/memoize.js");
...
module.exports.useSassTransformer = memoize(config => {
    ...
    const sassTransformer = blockingTransformer(async function sassTransformer(filename, content, query) {
