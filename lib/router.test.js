describe("router", function () {
    ...
    describe("unit test", function () {
        ...
        it("realistic", async () => {
            ...
            router.get("/**", cb("serve"));
            router.before("/**", cb("cache"));
            router.before("/web_modules/**", cb("resolve"));

            actual.length = 0;
            await router.route({req: {method: "GET", url: "/web_modules/@one/two/three.js"}});

            expect(actual).toMatchObject([
                {id: "cache", params: {}, pathname: "/web_modules/@one/two/three.js"},
                {id: "resolve", params: {}, pathname: "/@one/two/three.js"},
                {id: "serve", params: {}, pathname: "/web_modules/@one/two/three.js"}
            ]);
        });
    });
