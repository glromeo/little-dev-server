describe("router", function () {
    ...
    describe("unit test", function () {
        ...
        it("filters", async () => {
            ...
            router.after("/abc/:p/**", cb("after"));
            router.before("/abc/:p/**", cb("before"));
            ...
            expect(actual).toMatchObject([
                {id: "before", params: {p: "def"}, pathname: "/ghi/ijk"},
                {id: 1, params: {name: "abc"}, pathname: "/"},
                {id: "after", params: {p: "def"}, pathname: "/ghi/ijk"}
            ]);
